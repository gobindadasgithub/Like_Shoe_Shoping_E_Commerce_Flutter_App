  ...
  shoeInfo(width, height) {
    return FadeAnimation(
      ...
      child: Container(
        ...
        height: height / 9,
        child: Text(
            "Lorem ipsum dolor sit amet, consecrate disciplining elite. Pron incident lorem enum, wget soda les gulag sempre at. Sed id aliquot eros, nec vestibule fells. Nun maximus aliquot aliquot. Risque wget sapiens at veldt curses incident. Dis temper niacin erat wget ferment.",
